...
var s_account = BCUS.Tags.scode.account || "barclaysglobalacq";
...
s.linkInternalFilters="javascript:,barclaycardus.com,newcardprogram.com,mynewcardprogram.com"
...
else if (hostname.match(/barclaycardarrival.com/gi)) s.linkInternalFilters="javascript:,barclaycardarrival.com";
else if (hostname.match(/barclaycardtravel.com/gi)) s.linkInternalFilters="javascript:,barclaycardtravel.com";
else if (hostname.match(/HawaiianMastercard.com/gi)) s.linkInternalFilters="javascript:,HawaiianMastercard.com";
else if (hostname.match(/HawaiianAirlinesCard.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesCard.com";
else if (hostname.match(/HawaiianAirlinesMastercard.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesMastercard.com";
else if (hostname.match(/HawaiianAirlinesBOHCard.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesBOHCard.com";
else if (hostname.match(/HawaiianAirlinesBusinessCard.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesBusinessCard.com";
else if (hostname.match(/HawaiianAirlinesMC.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesMC.com";
else if (hostname.match(/HawaiianAirlinesBusinessMC.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesBusinessMC.com";
else if (hostname.match(/HawaiianAirlinesBizMC.com/gi)) s.linkInternalFilters="javascript:,HawaiianAirlinesBizMC.com";
else if (hostname.match(/TheHawaiianAirlinesCard.com/gi)) s.linkInternalFilters="javascript:,TheHawaiianAirlinesCard.com";
else s.linkInternalFilters="javascript:,barclaycardus.com";



/* Form Analysis Config (should be above doPlugins section) */
   s.formList="submitForm,LoginForm,DownloadTransForm,ExternalAccountForm,PayCreditCardForm,BalanceTransferForm,ActivationForm,SelfServiceForm,PassmarkVerificationForm,pppForm,TimeEnrollForm,CVV2Form,CustomerProfileForm,EnrollForm "	// please list all applicable form names here
...
function s_doPlugins(s) {
  ...
  /* exit link handler - clear all custom traffic vars from exit links */
  ...
  s.prop6=s.eVar6=s.getTimeParting('h','-5',currentYear); // Set hour
  s.prop7=s.eVar7=s.getTimeParting('d','-5',currentYear); // Set day
  s.prop8=s.eVar8=s.getTimeParting('w','-5',currentYear); // Set Weekend / Weekday
  ...
  s.eVar3=s.getQueryParam('qaid'); // useful for dev and QA purpose
  ...
  if(s.prop20&&!s.eVar21) s.eVar21=s.prop20;
  ...
  if(s.pageName&&!s.hier1) s.hier1=s.pageName;
   ...
   s.prop47=s.getPreviousValue(s.pageName,'gpv_pn');
  if (s.prop47){
	s.prop46=s.getPercentPageViewed();
  }

  s.prop48=s.eVar48="D=g";

  s.prop26='D=v26';      // passes eVar26 into prop26
  s.prop50=s.pageName +":"+ s.eVar26;   //concatenates pageName + eVar26 into a new prop50
  // s.prop50='D=pageName'+":"+ s.prop26;   //concatenates pageName + prop26 into a new prop50
  s.eVar50='D=c50';    //passes the new prop50 into new eVar50
...
var s_sv_suppressionSettings = {
              "suppressIfCookieExists": ["survey"],
              cookies: [{
                             "name": "survey", "value": "true",
                             "expiration": { "onShow": 0, "onLater": 0, "onNo": 0, "onSubmit": 0, "onCancel": 0 }
              }]
}
